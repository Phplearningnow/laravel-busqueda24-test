...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Profile V2 | Remark Admin Template</title>
          ...
          <div class="col-lg-12 col-xl-6 order-xl-2">
            ...
            <div class="user-release card card-shadow">
              <div class="card-block p-0">
                <input class="user-release-input form-control form-control-lg" type="text" name="user-content-input"
            ...
            <div class="user-info card card-shadow text-center">
              ...
              <div class="user-actions">
                ...
                <div class="dropdown">
                  ...
                  <i class="icon wb-share"></i> Real Gmat Test
                </a>
                    <a class="dropdown-item" href="#" role="menuitem">
                  <i class="icon wb-share"></i> Real Gmat Test
                </a>
